         ...
         <div class="col-md-12">
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title"> <i class="fas fa-plus mr-2"></i><b>Add Test</b> </h3><a href="{{route('professions.index')}}" class="btn btn-sm btn-info " style="float: right !important;"> <i class="fas fa-eye mr-1"></i> View Profession</a>
                 </div>
{{--                 @dd($doctor, $user);--}}
                 <div class="card-body">
                    <form action="{{route('provider.tests.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
