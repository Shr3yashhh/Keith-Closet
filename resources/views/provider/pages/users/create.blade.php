         ...
         <div class="col-md-12">
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title"> <i class="fas fa-plus mr-2"></i><b>Add New User</b> </h3><a href="{{route('provider.users')}}" class="btn btn-sm btn-info " style="float: right !important;"> <i class="fas fa-eye mr-1"></i> View User</a>
                 </div>
                 <div class="card-body">
                    <form action="{{route('provider.user.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <label for="phone"></label><input type="text" class="form-control" id="phone" name="phone" placeholder="Enter phone nunmber" value="">
                            @error('phone')
                            <span class="text-danger">{{$message}}</span>
