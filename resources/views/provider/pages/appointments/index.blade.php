...
{{--            @dd($appointment)--}}
                ...
                <div class="modal fade" id="activeModal{{$key}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="{{route('provider.appointments.manage',$appointment->id)}}" method="POST">
          ...
          <td>
              <a href="{{ route("provider.appointment.edit", $appointment->id) }}" class="btn btn-sm btn-info"> <i class="fas fa-edit mr-1"></i> Edit</a>
              <a onclick="return confirm('Are you sure?')" href="{{ route('provider.appointments.delete', $appointment->id) }}" class="btn btn-danger btn-sm">Delete</a>
          </td>
        </tr>
        @endforeach
      </table>
