...
{{--              <a href="{{url('provider-panel/request-list/'.Session::get('session_provider')->id.'/'.$notification['notification_id'])}}" class="dropdown-item">--}}
{{--                <div class="media bg-success p-2">--}}
...
{{--          @endif--}}
      ...
      <li class="nav-item">
        <a class="btn btn-danger" onclick="return(confirm('Are you sure you want to log out?'))" data-widget="Log out" href="{{route('provider.logout')}}" role="button">
