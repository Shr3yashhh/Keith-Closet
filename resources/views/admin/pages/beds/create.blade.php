         ...
         <div class="col-md-12">
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title"> <i class="fas fa-plus mr-2"></i><b>Add Bed</b> </h3><a href="{{route('professions.index')}}" class="btn btn-sm btn-info " style="float: right !important;"> <i class="fas fa-eye mr-1"></i> View BEds</a>
                 </div>
{{--                 @dd($doctor, $user);--}}
                 <div class="card-body">
                    <form action="{{route('admin.beds.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" class="form-control" name="bed_number" placeholder="Enter Bed Number">
                            @error('bed_number')
                        ...
                        <div class="form-group">
                            ...
                            <textarea required class="form-control" name="comment" placeholder="Enter Comment"></textarea>
