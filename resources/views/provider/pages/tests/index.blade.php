...
<div class="d-flex justify-content-between">
    ...
    <div class="mt-2">
        <a href="{{ route("provider.tests.show") }}">
...
{{--            </td>--}}
          ...
          <td>
              <a href="{{ route("provider.tests.edit", $test->id) }}" class="btn btn-sm btn-info"> <i class="fas fa-edit mr-1"></i> Edit</a>
              <a onclick="return confirm('Are you sure?')" href="{{ route('provider.tests.delete', $test->id) }}" class="btn btn-danger btn-sm">Delete</a>
              <a href="{{ route('provider.test.report', $test->id) }}" class="btn btn-success btn-sm">PDF</a>
          </td>
        </tr>
        @endforeach
      </table>
